...
export function fetchWrestlersByAthleteId<R extends Relationships.ToWrestler | void, I extends Exclude<FloObject, WrestlerObject> | void>(id: UUID, config: FetchConfig, include: readonly WrestlersIncludeString[] = ["bracketPlacements.weightClass", "division", "event", "weightClass", "team"], extra?: string): Promise<Responses.Wrestlers<R, I>> {
...
export function fetchWrestlersByWeightClass<R extends Relationships.ToWrestler | void, I extends Exclude<FloObject, WrestlerObject> | void>(id: UUID, config: FetchConfig, include: readonly string[] = [], extra?: string): Promise<Responses.Wrestlers<R, I>> {
