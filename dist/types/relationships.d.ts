...
export type RoundNameRelationship = {
    roundName: {
        data: RoundNameIdentifier;
    };
};
export type GradeRelationship = {
    grade: {
        data: GradeIdentifier;
    };
};
export type DivisionRelationship = {
    division: {
        data: DivisionIdentifier;
    };
};
export type BoutRelationship = {
    bout: {
        data: BoutIdentifier;
    };
};
...
export type BracketPlacementRelationship = {
    bracketPlacements: {
        data: BracketPlacementIdentifier[];
    };
};
